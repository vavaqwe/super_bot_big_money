...
MODE_PARAMS = {
    TradingMode.CONSERVATIVE: {
        "min_spread": 4.3,      # Мінімальний спред для входу
        "leverage": 4,          # Леверидж 4x
        "max_hold": 1.30,         # Максимум 45 хвилин утримання
        "tp": 2.5,              # Take Profit 2.4%
        "sl": -3.5,             # Stop Loss -5.8%
        "trailing": 0.5         # Trailing stop 0.5%
    },
    TradingMode.BULL: {
        "min_spread": 6.2,      # Менший спред для bull-ринку
...
ORDER_AMOUNT = 7.0  # 🔧 ПОВЕРНУТО: $5.0 маржа
...
CONVERGENCE_SPREAD_PCT = 1.8  # Поріг сходження (закривати якщо спред <= 0.5%)
...
ANTI_SHITCOIN_MIN_LIQUIDITY = 180000  # Мінімальна ліквідність $180,000
ANTI_SHITCOIN_MIN_VOLUME_24H = 500000  # Мінімальний об'єм 24h $2,500,000
ANTI_SHITCOIN_MAX_VOLATILITY_5M = 8.0  # Максимальна волатильність за 5 хв 8%
ANTI_SHITCOIN_MAX_VOLATILITY_1H = 35.0  # Максимальна волатільність за 1 год 35%
ANTI_SHITCOIN_MIN_TOKEN_AGE_DAYS = 14  # Мінімальний вік токену 14 днів
